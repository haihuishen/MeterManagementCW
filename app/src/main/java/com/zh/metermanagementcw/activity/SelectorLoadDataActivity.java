 ...
 * 功能选择界面
 */
public class SelectorLoadDataActivity extends BaseActivity implements OnClickListener {
	...
	private int[] mLayoutIds = {
			R.id.layout_setCopyTransformation, 	// 集抄改造
			R.id.layout_batchRepleceMeter,		// 批量换表
			R.id.layout_batchNewMeter,			// 批量新装
	...
	public int getContentLayout() {
		return R.layout.activity_selector_load_data;
	}
		...
		sa.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				switch (view.getId()) {
					...
					case R.id.layout_setCopyTransformation:					// 集抄改造
						// showToast("集抄改造！");
						intent = new Intent(SelectorLoadDataActivity.this, LoadDataSetCopyTransformationActivity.class);
						startActivity(intent);

						break;

					case R.id.layout_batchRepleceMeter:							// 批量换表
						showToast("批量换表！");
						break;

					case R.id.layout_batchNewMeter:							// 批量新装
						showToast("批量新装！");
						break;

					case R.id.layout_acceptance:							// 数据验收
						//showToast("数据验收！");
						intent = new Intent(SelectorLoadDataActivity.this, LoadDataAcceptanceActivity.class);
						startActivity(intent);
						break;
