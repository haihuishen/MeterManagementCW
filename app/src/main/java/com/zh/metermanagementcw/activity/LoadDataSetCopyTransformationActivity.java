...
public class LoadDataSetCopyTransformationActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getContentLayout() {
        return R.layout.activity_load_data_set_copy_transformation;
    }
