 ...
 *  加载 -- 数据验收 -- 数据
 */
public class LoadDataAcceptanceActivity extends BaseActivity implements View.OnClickListener {
    ...
    public int getContentLayout() {
        return R.layout.activity_load_data_acceptance;
    }
                ...
                SweetAlertDialog mSweetAlertDialog = new SweetAlertDialog(this, SweetAlertDialog.NORMAL_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                count = 0;
                                taskPresenter1.importDayExcelToDb(importDayObserver, files);
     ...
     * rxjava -- 主线程
     */
    Observer importDayObserver = new Observer<Long>() {
        ...
        public void onComplete() {
            ...
            File path = new File(Constant.Acceptance_Month_PATH);
            File[] files = path.listFiles();
            taskPresenter1.importMonthExcelToDb(importMonthObserver, files);
        }
    };
     ...
     * rxjava -- 主线程
     */
    Observer importMonthObserver = new Observer<Long>() {
