 ...
 * 功能选择界面
 */
public class SelectorNoWorkOrderActivity extends BaseActivity implements OnClickListener {
	...
	public int getContentLayout() {
		return R.layout.activity_selector_no_work_order;
	}
			...
			public void onAnimationEnd(Animation animation) {
				...
				switch (view.getId()) {
					...
					case R.id.layout_replaceMeter:							// 换表
						//showToast("换表！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, ReplaceMeterActivity1.class);
						startActivity(intent);
						break;

					case R.id.layout_newCollector:				 			// 新装采集器
						//showToast("新装采集器！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, NewCollectorActivity1.class);
						startActivity(intent);
						break;

					case R.id.layout_generateReports:				 			// generate_reports
						//showToast("generate_reports！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, GenerateReportsSetCopyTransformationActivity.class);
						startActivity(intent);
						break;

					case R.id.layout_statistics:									// 统计
						//showToast("查询！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, StatisticsSetCopyTransformationActivity.class);
						startActivity(intent);
					...
					case R.id.layout_query:									// 查询
						//showToast("查询！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, SearchSetCopyTransformationActivity.class);
						startActivity(intent);

						break;
					case R.id.layout_directionsForUse:				 		// 使用手册
						//showToast("使用手册！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, DirectionsForUseActivity.class);
						startActivity(intent);

						break;

					case R.id.layout_sendEmail:                            // 发送邮件
						intent = new Intent(SelectorNoWorkOrderActivity.this, SendEmailActivity.class);
						startActivity(intent);
						break;

					case R.id.layout_concentrator:							// 新装集中器
						//showToast("新装集中器！");
                        intent = new Intent(SelectorNoWorkOrderActivity.this, ConcentratorLocationActivity.class);
                        startActivity(intent);
						break;

					case R.id.layout_transformer:							// 变压器定位
						//showToast("变压器！");
						intent = new Intent(SelectorNoWorkOrderActivity.this, TransformerLocationActivity.class);
						startActivity(intent);
						break;
