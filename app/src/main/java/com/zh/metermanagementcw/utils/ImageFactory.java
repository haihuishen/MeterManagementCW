...
public class ImageFactory {
	 ...
	 * @throws FileNotFoundException    执行这个过程，一般都要检查错误
	 */
	public static void storeImageSize(Bitmap bitmap, String outPath, int size) throws FileNotFoundException {
		FileOutputStream os = new FileOutputStream(outPath);
		if(size <=0 || size>100)
			size = 70;
		bitmap.compress(Bitmap.CompressFormat.JPEG, size, os);			// 100==>不压缩
	}
