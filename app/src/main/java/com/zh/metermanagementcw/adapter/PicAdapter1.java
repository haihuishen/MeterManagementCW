 ...
 */
public class PicAdapter1 extends RecyclerView.Adapter<PicAdapter1.ViewHolder> {
     ...
     */
    public PicAdapter1(Context context, List<String> pathList, PicListener l) {
        this.pathList = pathList;
        this.context = context;
        this.listener = l;

        LogUtils.i("this.pathList：" + this.pathList.size());
    }

    @Override
    public int getItemCount() {
        LogUtils.i(pathList != null ? "getItemCount():" + pathList.size() : "getItemCount():" + 0);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (thumbNail != null) {                           // 有"略缩图"
            LogUtils.i("thumbNail 不为空:");
            holder.pv.setImageBitmap(thumbNail);
        } else {                                           // 没有"略缩图"
            LogUtils.i("thumbNail 为空:");
