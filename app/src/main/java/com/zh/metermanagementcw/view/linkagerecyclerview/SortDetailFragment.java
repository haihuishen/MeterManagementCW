...
import com.zh.metermanagementcw.activity.SelectorNoWorkOrderActivity;
            ...
            public void onItemClick(int id, int position) {
                ...
                switch (id) {
                    ...
                    case R.id.content:                      // 点击的是 -- 内容
                        ...
                        String path = Constant.SetCopyTransformation_PATH
                                + "导出数据/"
                        ...
                        bean.setAreaPhotoPath(path + NoWorkOrderPathBean.Photo);
                        ...
                        Intent intent = new Intent(getActivity(), SelectorNoWorkOrderActivity.class);
